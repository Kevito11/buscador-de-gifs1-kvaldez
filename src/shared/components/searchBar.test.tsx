...
describe('SearchBar', () => {
    test('should render searchBa correctly', () => {
    ...
    test('should call only once with the last calue (debounce)', async () => {
        const onQuery = vi.fn();
        render(<SearchBar onQuery={onQuery} />);
    ...
    test('should call onQuery when button clicked with the oinput value', async () => {
        const onQuery = vi.fn();
        render(<SearchBar onQuery={onQuery} />);
